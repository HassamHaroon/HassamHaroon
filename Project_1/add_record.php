...
if(isset($_POST['submit'])){
    ...
    $qry = "INSERT INTO add_record (fname, lname, ucity, uage, Phone, uemail, course, coursed, total_fee) VALUES ('$input_fname','$input_lname', '$input_ucity', '$input_uage', '$input_Phone', '$input_uemail', '$input_course', '$input_coursed', '$input_total_fee')";
    mysqli_query($db,$qry);


    echo"<script>
    alert('Add Data sucessfully');
    document.location='add_record.php';
...
<body class="add_record_body">
    ...
    <div class="col mt-5">
                <div class="signup_form">
                    <form method="post">
                        <p class="h3 text-center signup_h1">ADD RECORD</p>
